...
const Register = () => {
  ...
  return (
    <div className="Register-root flex justify-center items-center">
    <StyledWrapper>
      <form  className="Register border-2 my-12" onSubmit={handleSubmit(sumitHandler)}>
        ...
        <div className="inputRegister">
          ...
          <input type="password" className="input" name='password' placeholder="Enter your Password" 
           {...register("password", { required: "password is Required!", minLength:{
            value:6,
            message: "atlest 6 charcter is required ",
           },
          pattern:{
            value:/^[0-9A-Za-z .$@#]{6,30}/,
            message:"only alphabet,digit,space,.,$,#,@ is acepted and length must be 6-30 charcters"
          }
          })} 
